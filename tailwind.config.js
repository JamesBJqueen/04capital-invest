  ...
  theme: {
    extend: {
      ...
      fontFamily: {
        ...
        "material_symbols_outlined": ["Material Symbols Outlined", "ui-sans-serif", "system-ui", "sans-serif", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"],
