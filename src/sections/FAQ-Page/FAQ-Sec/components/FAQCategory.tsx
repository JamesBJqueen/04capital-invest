      ...
      <ul className="box-border caret-transparent list-none pl-0">
        {props.items.map((item, index) => (
          ...
          >
            <button
              type="button"
              className="text-stone-950/30 text-[13.3333px] items-center bg-transparent caret-transparent gap-x-3 flex justify-between leading-[normal] gap-y-3 text-left w-full px-[1.6px] py-[14.4px] font-arial"
            >
              ...
              <span
                className={
                  item.isExpanded
                    ? "text-white text-[12.8px] items-center bg-[linear-gradient(135deg,rgb(0,80,179),rgb(29,143,255))] box-border caret-transparent flex shrink-0 h-[22px] justify-center w-[22px] border rounded-[999px] border-solid border-transparent"
                    : "text-gray-600 text-[12.8px] items-center bg-gray-50 box-border caret-transparent flex shrink-0 h-[22px] justify-center w-[22px] border border-indigo-200 rounded-[999px] border-solid"
                }
              >
                +
              </span>
