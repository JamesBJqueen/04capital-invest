    ...
    <form onSubmit={onSubmit} ref={formRef} className="box-border caret-transparent">
      ...
      <div className={step === 3 ? 'box-border caret-transparent' : 'box-border caret-transparent hidden'}>
        ...
        <div className="box-border caret-transparent mt-[12.8px]">
          ...
          <label className="text-gray-600 text-[13.76px] items-start bg-gray-50 box-border caret-transparent gap-x-2 flex leading-[22.016px] gap-y-2 border border-gray-200 mb-[10.4px] px-[14.4px] py-3 rounded-xl border-solid cursor-pointer">
            <input type="checkbox" name="accept_esign" className="w-4 h-4 mt-1" />
            <span className="box-border caret-transparent block">
          ...
          <label className="text-gray-600 text-[13.76px] items-start bg-gray-50 box-border caret-transparent gap-x-2 flex leading-[22.016px] gap-y-2 border border-gray-200 mb-[10.4px] px-[14.4px] py-3 rounded-xl border-solid cursor-pointer">
            <input type="checkbox" name="accept_terms_conditions" className="w-4 h-4 mt-1" />
            <span className="box-border caret-transparent block">
              I agree to the
              <a
                href="https://04capitalinvestment.com/terms-and-conditions"
          ...
          <label className="text-gray-600 text-[13.76px] items-start bg-gray-50 box-border caret-transparent gap-x-2 flex leading-[22.016px] gap-y-2 border border-gray-200 mb-[10.4px] px-[14.4px] py-3 rounded-xl border-solid cursor-pointer">
            <input type="checkbox" name="accept_final_review" className="w-4 h-4 mt-1" />
            <span className="box-border caret-transparent block">
      ...
      <div className={step === 4 ? 'box-border caret-transparent' : 'box-border caret-transparent hidden'}>
        ...
        <div className="box-border caret-transparent gap-x-[20.8px] grid grid-cols-[minmax(0px,1fr)] gap-y-[20.8px] mt-[17.6px] md:grid-cols-[minmax(0px,1.2fr)_minmax(0px,1fr)]">
          <div className="bg-white bg-[radial-gradient(circle_at_0%_0%,rgba(0,80,179,0.16),rgba(0,0,0,0)_60%),none] bg-size-[auto,auto] shadow-[rgba(148,163,184,0.25)_0px_12px_30px_0px] box-border caret-transparent gap-x-[9.6px] flex flex-col gap-y-[9.6px] border border-sky-700/70 bg-[position:0%,0%_0%,0%] pt-4 pb-[17.6px] px-4 rounded-[18px] border-solid">
            <div className="items-center box-border caret-transparent gap-x-[11.2px] flex gap-y-[11.2px]">
              <div className="text-[17.6px] items-center bg-slate-100 box-border caret-transparent flex h-[34px] justify-center leading-[28.16px] w-[34px] border border-sky-700/70 rounded-[999px] border-solid">
                <span className="bg-orange-500 box-border caret-transparent block h-[7px] w-[7px] rounded-[999px]"></span>
              </div>
              <div className="box-border caret-transparent">
                <h3 className="text-gray-900 font-bold box-border caret-transparent">
                  Connect with Plaid – Recommended
                </h3>
                <p className="text-gray-600 text-[12.8px] box-border caret-transparent leading-[20.48px] mt-[1.6px]">
                  Fastest review
                </p>
              </div>
            </div>
            <p className="text-gray-600 text-[13.76px] box-border caret-transparent leading-[22.016px] mt-[3.2px] mb-[6.4px]">
              Securely connect your business bank account and let Plaid share up
              to 6 months of activity. No PDFs or manual uploads required.
            </p>
            <button
              type="button"
              onClick={() => {
              ...
              className="text-white text-[14.4px] font-semibold items-center bg-transparent bg-[linear-gradient(135deg,rgb(0,80,179),rgb(29,143,255))] shadow-[rgba(0,80,179,0.35)_0px_16px_35px_0px] caret-transparent gap-x-[5.6px] flex justify-center leading-[normal] gap-y-[5.6px] text-center w-full border px-[20.8px] py-[9.6px] rounded-[999px] border-solid border-transparent font-arial hover:shadow-[rgba(0,80,179,0.45)_0px_20px_45px_0px]"
            >
            ...
            <div className="text-[16.8px] font-semibold box-border caret-transparent leading-[26.88px] text-center mt-1.5"></div>
          </div>
          <div className="bg-white bg-[radial-gradient(circle_at_100%_0%,rgba(245,128,37,0.16),rgba(0,0,0,0)_60%),none] bg-size-[auto,auto] shadow-[rgba(148,163,184,0.25)_0px_12px_30px_0px] box-border caret-transparent gap-x-[9.6px] flex flex-col gap-y-[9.6px] border border-slate-200 bg-[position:0%,0%_0%,0%] pt-4 pb-[17.6px] px-4 rounded-[18px] border-solid">
            <div className="items-center box-border caret-transparent gap-x-[11.2px] flex gap-y-[11.2px]">
              <div className="text-[17.6px] items-center bg-slate-100 box-border caret-transparent flex h-[34px] justify-center leading-[28.16px] w-[34px] border border-orange-500/80 rounded-[999px] border-solid">
                📄
              </div>
              <div className="box-border caret-transparent">
                <h3 className="text-gray-900 font-bold box-border caret-transparent">
            ...
            <p className="text-gray-600 text-[13.76px] box-border caret-transparent leading-[22.016px] mt-[3.2px] mb-[6.4px]">
              Upload up to 3 most recent months of business bank statements (PDF
              only, maximum 10 MB per file).
            </p>
            <button
              type="button"
              onClick={() => setShowManualUpload(!showManualUpload)}
              className="text-[14.4px] font-semibold items-center bg-sky-100 caret-transparent gap-x-[5.6px] flex justify-center leading-[normal] gap-y-[5.6px] text-center w-full border border-blue-200 mt-[6.4px] px-[20.8px] py-[9.6px] rounded-[999px] border-solid font-arial hover:bg-blue-100"
            >
              Use manual uploads instead
            </button>
            <div className={`box-border caret-transparent ${showManualUpload ? '' : 'hidden'} mt-[12.8px]`}>
              <p className="text-gray-600 text-[12.48px] box-border caret-transparent leading-[19.968px] mt-[4.8px] mb-[12.48px]">
                Drag &amp; drop files into each box, or click to browse from
                your computer.
              </p>
              <div className="box-border caret-transparent gap-x-4 grid grid-cols-[minmax(0px,1fr)] gap-y-4">
                <div className="text-[13.44px] bg-gray-50 box-border caret-transparent leading-[21.504px] min-h-[88px] text-center border border-slate-400/90 px-[14.4px] py-[17.6px] rounded-[14px] border-dashed md:min-h-0 md:px-[12.8px] md:py-[14.4px]">
                  <input
                    type="file"
                    name="bank_statements[]"
                    className="text-neutral-600 text-[13.3333px] items-baseline bg-transparent box-border caret-transparent hidden leading-[normal] text-start text-ellipsis text-nowrap p-0 font-arial"
                  />
                  <p className="text-[14.4px] box-border caret-transparent leading-[23.04px] my-[3.2px] md:text-[13.44px] md:leading-[21.504px]">
                    <span className="text-[14.4px] box-border caret-transparent leading-[23.04px] underline md:text-[13.44px] md:leading-[21.504px]">
                      Click or drag file here
                    </span>
                  </p>
                  <p className="text-gray-600 text-[14.4px] box-border caret-transparent leading-[23.04px] my-[3.2px] md:text-[12.48px] md:leading-[19.968px]">
                    No file selected
                  </p>
                  <div className="items-center box-border caret-transparent gap-x-2 hidden flex-wrap min-h-6 gap-y-2 mt-2">
                    <div className="bg-gray-300/80 box-border caret-transparent h-[5px] max-w-[180px] min-w-[140px] overflow-hidden mt-[1.6px] rounded-[999px]">
                      <div className="bg-[linear-gradient(90deg,rgb(79,209,197),rgb(49,130,206))] box-border caret-transparent h-full w-0 rounded-[999px]"></div>
                    </div>
                    <div className="text-gray-600 text-xs box-border caret-transparent leading-[19.2px] text-nowrap">
                      Uploading: 0%
                    </div>
                  </div>
                  <div className="items-center box-border caret-transparent gap-x-3 flex justify-end gap-y-3 mt-[6.4px] md:justify-between">
                    <button
                      type="button"
                      className="text-[13.6px] bg-transparent caret-transparent block leading-[normal] underline p-0 font-arial"
                    >
                      Remove
                    </button>
                  </div>
