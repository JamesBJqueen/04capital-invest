              ...
              <div className="box-border caret-transparent gap-x-4 grid grid-cols-[minmax(0px,1fr)] gap-y-4">
                {[0, 1, 2].map((index) => {
                  ...
                  return (
                    <div
                      key={index}
                      className={`text-[13.44px] bg-gray-50 box-border caret-transparent leading-[21.504px] min-h-[88px] text-center border px-[14.4px] py-[17.6px] rounded-[14px] border-dashed md:min-h-0 md:px-[12.8px] md:py-[14.4px] cursor-pointer transition-colors ${isDragOver ? 'border-sky-400 bg-sky-50' : 'border-slate-400/90'}`}
                      onDragOver={(e) => {
                        e.preventDefault();
                      ...
                      {file ? (
                        <>
                          <div className="flex items-center justify-center gap-2 mb-2">
                            ...
                            <span className="text-[14.4px] font-medium text-gray-700 truncate max-w-[200px]">{file.name}</span>
                          </div>
                          ...
                          <button
                            ...
                            className="text-[13.6px] bg-transparent caret-transparent block leading-[normal] underline p-0 font-arial text-red-500 hover:text-red-700"
                          >
                            Remove
                          </button>
                        </>
